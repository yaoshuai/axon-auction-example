...
/**
 * Base class for command related checked exceptions.
 */
public abstract class CommandCheckedException extends Exception implements CommandException {
	 ...
	 *            Error message.
	 */
	public CommandCheckedException(final int messageId, final String message) {
